    ...
    if (location.host === "www.jianshu.com") { _Ds = jianshu } else {
        ...
        window.addEventListener("DOMContentLoaded", () => {
            ...
            window.onload = () => {
                ...
                // 重写所有复制按钮
                document.querySelectorAll('.hljs-button.signin, .btn-code-notes').forEach(btn => {
                    // 设置初始提示
                    if(btn.classList.contains('hljs-button')) {
                        btn.setAttribute("data-title", "自由复制");
                    }
                    ...
                    btn.onclick = function(e) {
                        ...
                        if (codeText) {
                            ...
                            try {
                                ...
                                if (successful) {
                                    // 更新按钮提示语（2秒后恢复）
                                    const originalTitle = this.getAttribute('data-title') || this.title;
